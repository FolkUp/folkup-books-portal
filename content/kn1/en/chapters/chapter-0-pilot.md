---
title: "Phileas Fogg Invented What Is Now Killing Modern Corporations"
description: "How a fictional English gentleman of 1872 intuitively applied the principles that the modern Agile industry has commercialized, distorted, and sold back at a cost of billions"
date: 2026-04-08
...
og_title: "Chapter 0: Phileas Fogg Invented Agile Before Agile"
og_description: "The pilot chapter: how the nineteenth century intuitively applied the principles of the future. From a trip around the world to corporate sprints."
twitter_description: "How Phileas Fogg invented Agile 129 years before the Manifesto. An analysis of intuitive method versus modern commercialization."
toc: true
draft: false
status: verified
sources:
  - "Jules Verne. *Around the World in Eighty Days* (1872/1873). Hetzel, Paris. Public domain."
  - "Bank of England inflation calculator / UK Inflation Calculator (officialdata.org). Data on the purchasing power of £20,000 in 1872."
confidence: high
...
⁹ Jules Verne. *Around the World in Eighty Days* (1872/1873). Hetzel, Paris. Public domain. All quotations from the novel are given in the author's translation. Chapter I (description of Fogg, daily route: **575 steps with his right foot and 576 with his left**, per the Verne original), Chapter II (Passepartout, "a real machine"), Chapter XI (Kholby station, the newspaper announcement of the railway's completion, the purchase of the elephant). **Translator's note on characterization:** the body's compound-shorthand — «the man of 576 steps», «576-steps-with-the-right-foot» — mirrors the RU-эталon's metonymic figure (RU v1.0.20 baseline carries the same authored pattern after the correct 575/576 quote); the discrepancy is deliberate mirroring per translation contract, RU baseline not re-opened (per PROTOKOL DVUH VETOK v1.0, Iskra S260).
...
¹⁴ Jules Verne. *Around the World in Eighty Days* (1872/1873). Hetzel, Paris. Public domain. Chapters XII–XIII: the rescue of Aouda from the sati rite. Quotation — author's translation. Original French: "J'ai douze heures d'avance; je puis en consacrer six à cela." (Ch. XII). Note: the RU master (v1.0.20 text baseline) renders "twelve hours in hand" and "devote them," a mild paraphrase of the French "six of them"; EN v0.1 preserves the RU authorial choice.

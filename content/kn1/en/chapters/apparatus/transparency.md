...
Automated tools were used for searching, analyzing, and verifying sources, and processing large volumes of textual data.
...
All analytical conclusions, interpretations, and arguments belong to the author.

**Creative decisions**
The book's structure, choice of literary parallels, and conceptual connections were developed by humans.

**Research methodology**
The research approach, verification principles, and academic standards were defined by the author.
...
This statement is updated as the use of AI tools changes. The current version is always available at [/apparatus/transparency/](/apparatus/transparency/).

---
title: "Colofão"
description: "Informação editorial — quem, quando, como este livro foi criado"
weight: 10
---
...
**Editora:** Iskra
**Tradutor (russo → português europeu):** Zeka (S2PT)
...
**Titular legal dos direitos de autor (©):** Andrei Klemenchenok (ORCID: [0009-0008-2953-8601](https://orcid.org/0009-0008-2953-8601))
...
**Plataforma:** Vue 3 + Vite SSG + leitor próprio
**Alojamento:** Cloudflare Pages
**Domínio:** [books.folkup.life/kn1/pt/read/](https://books.folkup.life/kn1/pt/read/)
**Licença de conteúdos:** [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) (Attribution-ShareAlike)
**Código-fonte:** [GitHub — folkup-books-portal](https://github.com/FolkUp/folkup-books-portal)

**Coerência de licenciamento:** A edição-mãe russa (v1.0.10+, desde 2026-06-25) está licenciada sob CC BY-SA 4.0 por cânone da série FolkUp (S100, 2026-06-22). Esta tradução portuguesa herda a mesma licença.

## Editora

**Ecossistema FolkUp**
Editora digital de conteúdos especializados
...
- **Editora:** Iskra
- **Tradutor:** Zeka (S2PT)
- **Revisão editorial e Vier-Augen (PT-EU):** Iskra (padrões Priberam · Infopédia · Academia das Ciências de Lisboa · Ciberdúvidas)
- **Ilustradora:** Frida
- **Titular legal dos direitos de autor (©):** Andrei Klemenchenok (ORCID: 0009-0008-2953-8601)

**Ferramentas editoriais (automatização):** verificação OSINT, revisão técnica, análise de ritmo poético, revisão adversarial — executadas por assistentes de IA especializados no ecossistema editorial FolkUp. Divulgação detalhada — na [página de Transparência sobre IA](/kn1/pt/read/apparatus-transparency).

## Datas da Edição

**Início do trabalho:** março de 2026 (edição-mãe russa)
**Edição-mãe russa — primeira publicação:** 2026-05-26
**Edição-mãe russa — versão atual:** 1.0.25 (2026-08-16)
**Edição portuguesa — início da tradução:** agosto de 2026 (pipeline S2PT, Zeka)
**Edição portuguesa — primeira entrega parcial:** agosto de 2026 (v0.9 pré-lançamento; Vier-Augen em curso)

---
title: "Capítulo 11: A Peste. Como se forma uma equipa em regime de crise prolongada"
description: "Albert Camus «A Peste» 1947 — a communauté do doutor Rieux, Tarrou, Castel, Rambert, Grand e Paneloux: quatro leis do trabalho prolongado sob uma crise sem horizonte de vitória — a recusa como compromisso, a decência comum em vez do heroísmo, a convergência sem hierarquia, a disciplina da continuação."
date: 2026-05-25
...
chapter: 11
act: "III: Horizontes"
category: "ética-da-crise"
status: "verified"
sources:
  - "Camus, Albert. *La Peste.* Paris: Gallimard, 1947."
  - "Camus, Albert. *A Peste.* Tradução nossa a partir do original francês."
  - "Camus, Albert. *Le Mythe de Sisyphe.* Paris: Gallimard, 1942."
  - "Chalámov V.T. *Contos de Kolimá.* Ciclo escrito 1954–1973; primeira edição integral na URSS — Moscovo: Khudójestvennaia Literatura, 1991."
...
prev_chapter: "/pt/kn1/chapters/chapter-9-niichavo"
next_chapter: ""
act_overview: "Ato III: Horizontes — para onde caminhamos"
act_prev: "/pt/kn1/chapters/chapter-9-niichavo"
act_conclusion: true

# Slug-rename redirect — antigo caminho serve meta-refresh para o novo
aliases:
  - "/chapters/chapter-10-choice-engine/"
  - "/chapters/chapter-10-choice-engine"

# SEO Enhancement
keywords: ["Albert Camus", "A Peste", "doutor Rieux", "crise prolongada", "decência comum", "communauté", "recusa como compromisso", "ética do absurdo"]
og_title: "Capítulo 11: A Peste — como se forma uma equipa em regime de crise prolongada"
og_description: "Camus «A Peste» 1947: a communauté de Rieux, Tarrou, Castel, Rambert, Grand e Paneloux como ética operacional para uma equipa sem horizonte de vitória."
twitter_description: "Final do livro: Camus mostra a equipa que se sustenta pela recusa em partir, não pelo amor ao ofício."
---

![Gravura do capítulo: A Peste. Equipa em regime de crise prolongada](/kn1/images/chapters/agil-chapter-10-plate.webp)
...
¹ Camus, Albert. *La Peste.* Paris: Gallimard, 1947, partie II. Conversa de Rieux com Rambert, na presença de Tarrou. No original: *«la seule façon de lutter contre la peste, c'est l'honnêteté»* — *«être honnête, c'est faire son métier»*. Em português, *honnêteté* verte-se habitualmente por «honestidade» — é esta a forma literal que damos nas citações. Ao mesmo tempo, este capítulo mantém a palavra «decência» na moldura conceptual (título da lei 2, tese final), sublinhando o parentesco com a tradição anglófona de *common decency* de Orwell: é uma opção autoral consciente de tradução. Tradução nossa a partir do original francês.

² Camus, Albert. Carta a Roland Barthes, 11 de janeiro de 1955. Resposta de Camus à recensão de Barthes no *Club, le journal du meilleur livre* (janeiro de 1955), onde Barthes lera «A Peste» como alegoria «anti-histórica». Camus na carta insiste que a peste não é apenas o nazismo; o romance fala de resistência a qualquer tirania, a qualquer terror. Carta publicada em: Camus, Albert. *Théâtre, récits, nouvelles.* Edição de Roger Quilliot, Bibliothèque de la Pléiade. Paris: Gallimard, 1962, pp. 1965–1967.
...
⁸ Camus, *La Peste,* partie II, sermão de Paneloux na catedral de Oran. No original: *«Mes frères, vous êtes dans le malheur, mes frères, vous l'avez mérité.»* Tradução nossa a partir do original francês.

...
/**
 * kn.3 «Город Солнца» reader TOC (/kn3/read).
 */
  ...
  meta: [
    {
      name: 'description',
      content:
        'Оглавление книги «Город Солнца. Ретроспектива 2026». Читать бесплатно онлайн — все главы, эпилог, приложения.',
    },
    { property: 'og:title', content: 'Читать онлайн — Город Солнца' },
    { property: 'og:type', content: 'book' },
    { property: 'og:url', content: `${SITE_URL}/kn3/read/` },
    {
      property: 'og:description',
      content: 'Оглавление книги — читать онлайн бесплатно.',
    },
  ],
  link: [{ rel: 'canonical', href: `${SITE_URL}/kn3/read/` }],
})
...
<template>
  <main class="reader-toc">
    ...
    <header class="reader-toc__header">
      <h1>Город Солнца</h1>
      <p class="reader-toc__subtitle">Ретроспектива 2026</p>
      <p class="reader-toc__hint">
        Читать онлайн бесплатно. Также доступно в форматах
        <a href="/kn3/downloads/city-of-the-sun-v1.0.1.epub" download>EPUB</a>
        (PDF готовится).
      </p>
    </header>
    ...
    >
      ...
      <ol class="reader-toc__list">
        <li v-for="entry in section.entries" :key="entry.slug">
          <RouterLink :to="`/kn3/read/${entry.slug}`" class="reader-toc__link">
            <span class="reader-toc__link-title">{{ entry.title }}</span>
          </RouterLink>
        </li>
      </ol>
      <p v-if="section.title === 'Аппарат'" class="reader-toc__apparatus-note">
        <strong>Приложение А1 «Указатель имён»</strong> — большой сводный
        указатель (более пятисот страниц) — доступен в EPUB-версии книги.
      </p>
    </section>
  </main>
</template>
...
.reader-toc__apparatus-note {
  font-size: 0.9rem;
  color: var(--color-text-muted, #666);
  margin: 1rem 0 0;
  padding: 0.8rem 1rem;
  background: var(--color-hint-bg, #faf6f0);

...
import { useKn7Chapters } from '../composables/useKn7Chapters'

const chapters = useKn7Chapters()
...
useHead({
  title: 'Читать онлайн — Трудности диалога — Библиотека FolkUp',
  meta: [
    {
      name: 'description',
      content:
        'Оглавление книги «Трудности диалога. Книга 7 · Трилогия «Общий язык»». Читать бесплатно онлайн.',
    },
    { property: 'og:title', content: 'Читать онлайн — Трудности диалога' },
    { property: 'og:type', content: 'book' },
    { property: 'og:url', content: `${SITE_URL}/kn7/read/` },
  ],
  link: [{ rel: 'canonical', href: `${SITE_URL}/kn7/read/` }],
})
...
<template>
  <main class="reader-toc">
    ...
    <header class="reader-toc__header">
      <h1>Трудности диалога</h1>
      <p class="reader-toc__subtitle">Книга 7 · Трилогия «Общий язык»</p>
    ...
    >
      ...
      <ol class="reader-toc__list">
        <li v-for="entry in section.entries" :key="entry.slug">
          <RouterLink :to="`/kn7/read/${entry.slug}`" class="reader-toc__link">

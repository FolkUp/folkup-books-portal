...
useHead({
  title: () =>
    ...
    ' — Город Солнца — Библиотека FolkUp',
  meta: () => [
    {
      name: 'description',
      content:
        ...
        'Читать онлайн — глава книги «Город Солнца».',
    },
    {
      property: 'og:title',
    ...
    {
      property: 'og:url',
      content: `${SITE_URL}/kn3/read/${slug.value}/`,
    },
  ],
  link: () => [
    { rel: 'canonical', href: `${SITE_URL}/kn3/read/${slug.value}/` },
  ],
})
</script>

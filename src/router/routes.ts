...
export const routes: RouteRecordRaw[] = [
  ...
  // Legal pages DE — real components (Bolik CASCADE-ADDENDUM applied per Iskra Vier-Augen S301-15
  // PASS «одним PR» + Iskra S301-16 гражданство V2 verdict + Iskra S301-14 apply discipline; routes
  // stubs → real components симметрично PT pattern per PR #241, per Bolik heads-up POMETKA-Alisa-cont6
  // option A executed here).

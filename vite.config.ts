...
export default defineConfig({
  ...
  ssgOptions: {
    ...
    onFinished() {
      const readerCount =
        KN1_READER_ROUTES.length + KN3_READER_ROUTES.length + KN4_READER_ROUTES.length
      console.log(`vite-ssg build finished. Prerender includes ${readerCount} reader routes (kn.1: ${KN1_READER_ROUTES.length} + kn.3: ${KN3_READER_ROUTES.length} + kn.4: ${KN4_READER_ROUTES.length}). Verify sitemap.xml + hreflang links.`)
    },
  },
})

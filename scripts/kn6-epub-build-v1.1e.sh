#!/bin/bash
#
# kn.6 «Своими глазами» EPUB v1.1e generator (pandoc-based)
...
BUILD_DIR="/c/Transit/kn6-build-v1.1e"

EPUB_VERSION="${1:-v1.1e}"
...
OUTPUT = os.environ.get('OUTPUT_EPUB', '/c/Transit/kn6-build-v1.1e/kn6-svoimi-glazami-v1.1e.epub')
...
NAV_REFS=$(unzip -p "$OUTPUT_EPUB" EPUB/content.opf | grep -c 'idref="nav"' || echo 0)
...
echo ""
echo "🎉 kn.6 EPUB v1.1e build complete!"
